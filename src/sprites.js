 ...
 *
 * base 는 droop 귀 상자(행5~7, 열26~28) 한가운데를 찍어야 귀가 밑동을
 * 덮어줍니다. 예전 좌표(23,5)는 이 상자 밖이라 귀가 거의 못 가리고,
 * 대신 머리 실루엣 경계(행6에서 열25까지)가 밑동을 삐뚤빼뚤 잘라
 * "귀 뒤에 숨음"이 아니라 "머리에 잘림"으로 보였습니다. 열을 26 이상
 * (머리가 어느 행에서도 닿지 않는 영역)으로만 두면 이 문제가 아예
 * 생기지 않습니다.
 */
